...
fn test_6_decimal_bond_creation() {
    ...
    let bond = client.create_bond(&identity, &native_amount, &86400, &false, &0);
...
fn test_6_decimal_withdrawal() {
    ...
    let native_amount = 1_000_000_000_i128;
    client.create_bond(&identity, &native_amount, &86400, &false, &0);
...
fn test_minimum_bond_amount_6_decimals() {
    ...
    let bond = client.create_bond(&identity, &min_native_6, &86400, &false, &0);
    ...
    let bond1 = client1.create_bond(&identity1, &min_native_18, &86400, &false, &0);
...
fn test_tier_boundaries_with_different_decimals() {
    ...
    for decimals in [6, 8, 18] {
        ...
        let bond =
            client.create_bond(&identity, &native_1000_tokens, &86400, &false, &0);
        assert_eq!(
            client.get_tier(),
            BondTier::Silver,
