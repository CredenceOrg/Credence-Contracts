...
- `docs/` — Feature docs (`EVENTS.md`, `PATTERNS_EVENTS.md`, `DEDUP_POLICY.md`, `rolling-bonds.md`, `early-exit.md`, `slashing.md`, `tier-system.md`, `delegation.md`, `emergency.md`, `UPGRADE.md`, `TIME_UNITS.md`, `ADMIN_EPOCHS.md`, [`COMPOUND_RATE.md`](docs/COMPOUND_RATE.md), [`TTL_POLICY.md`](docs/TTL_POLICY.md))
